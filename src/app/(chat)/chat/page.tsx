...
export default function ChatPage() {
  ...
  return (
    ...
    >
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-y-none min-w-0">
        <div className="flex min-h-full flex-col items-center justify-center px-4 py-8 sm:p-8">
          <div className="w-full min-w-0 max-w-4xl text-center">
            <div className="mb-6 sm:mb-8">
              ...
              <h1 className="font-display mt-4 text-3xl font-bold uppercase leading-none sm:text-4xl">
                {greeting}
              </h1>
