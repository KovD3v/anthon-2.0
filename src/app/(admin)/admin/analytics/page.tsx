		...
		<div>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
				...
				<Card className="bg-background/60 backdrop-blur-xl border-white/10 shadow-xl">
					...
					<CardContent>
						{usageStats?.usersByDay &&
						usageStats.usersByDay.length > 0 ? (
							<ResponsiveContainer width="100%" height={300}>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
				<Card className="bg-background/60 backdrop-blur-xl border-white/10 shadow-xl">
					...
					<CardContent>
						{costStats?.costByModel &&
						costStats.costByModel.length > 0 ? (
							<ResponsiveContainer width="100%" height={300}>
								<PieChart>
									<Pie
								...
								<div className="pt-4 border-t border-border">
									<div className="flex justify-between text-sm">
										...
										<span className="font-bold text-green-600">
											{funnelStats.conversionRates.overallConversion.toFixed(
												1
											)}
											%
										</span>
