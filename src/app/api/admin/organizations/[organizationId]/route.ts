...
export async function GET(
  ...
  return withRequestLogContext(
    req,
    { route: "/api/admin/organizations/[organizationId]", channel: "WEB" },
    async () => {
      ...
      try {
        ...
        organizationsLogger.error(
          "organizations.api.detail.get_failed",
          "Organization Detail API GET failed",
          { error },
        );
        return NextResponse.json(
  ...
  return withRequestLogContext(
    ...
    async () => {
      ...
      try {
        ...
        organizationsLogger.error(
          "organizations.api.detail.patch_failed",
          "Organization Detail API PATCH failed",
          { error },
        );
        return NextResponse.json(
  ...
  return withRequestLogContext(
    ...
    async () => {
      ...
      try {
        ...
        organizationsLogger.error(
          "organizations.api.detail.delete_failed",
          "Organization Detail API DELETE failed",
          { error },
        );
        return NextResponse.json(
