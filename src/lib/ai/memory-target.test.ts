...
describe("ai/memory-target", () => {
  ...
  it.each([
    ...
    "Dimentica il mio errore in gara e ricominciamo.",
    "Dimentica il mio errore in gara e ricominci.",
    "Dimentica il mio errore in gara e ricominciate.",
    "Dimentica il mio errore in gara e prova a ricominciare.",
    "Dimentica il mio errore in gara e cerchiamo di ricominciare.",
    "Dimentica il mio errore in gara e ricominciando guardiamo avanti.",
    "Dimentica il mio errore in gara e ricominceremo domani.",
