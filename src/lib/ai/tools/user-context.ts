...
Usa questo tool quando l'utente esprime preferenze su come vuole essere comunicato,
come il tono (formale/informale), la modalità di coaching o la lingua.`,
      inputSchema: z.object({
        tone: z
          .string()
          .optional()
        ...
        try {
          const preferences = await prisma.preferences.upsert({
            ...
            update: {
              ...
              ...(params.push !== undefined && { push: params.push }),
            },
            create: {
              userId,
              tone: params.tone,
